...
\lstinputlisting[language=Python,firstline=42,lastline=136,caption={保持平稳边际的Markov天气模型与序列采样},label={code:markov-weather}]{../src/desert/weather.py}
...
\lstinputlisting[language=Python,firstline=10,lastline=130,caption={第六关最短路枚举、角色策略与单边偏离构造},label={code:level6-oracle}]{../src/desert/level6_oracle.py}
...
\lstinputlisting[language=Python,firstline=213,lastline=265,caption={角色条件装载的分布鲁棒校准},label={code:robust-calibration}]{../scripts/analyze_robustness.py}

\lstinputlisting[language=Python,firstline=319,lastline=361,caption={受约束最佳响应预言机的完整候选筛选},label={code:oracle-screening}]{../scripts/analyze_robustness.py}
